...
set output \"m5out/NoI_KiteSmall/stats/throughput.png\"

plot \"m5out/NoI_KiteSmall/stats/throughput_plot/uniform_random.txt\" smooth unique with linespoints linecolor 1 linewidth 1.5 pointtype 1 pointsize 2 title \"uniform random\", \
" | gnuplot
}
...
set key top left
set terminal pngcairo size 1280, 720
set output \"m5out/NoI_Mesh/stats/latency.png\"


plot \"m5out/NoI_Mesh/stats/latency_plot/uniform_random.txt\" smooth unique with linespoints linecolor 1 linewidth 1.5 pointtype 1 pointsize 2 title \"uniform random\", \
" | gnuplot
}
