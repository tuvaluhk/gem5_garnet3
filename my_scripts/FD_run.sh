...
echo
echo "Run: Stats:"
grep "sim_ticks" my_outdir/NoI/FoldedTorus/stats.txt
grep "average_packet_latency" my_outdir/NoI/FoldedTorus/stats.txt
grep "average_hops" my_outdir/NoI/FoldedTorus/stats.txt
grep "packets_injected::total" my_outdir/NoI/FoldedTorus/stats.txt
grep "packets_received::total" my_outdir/NoI/FoldedTorus/stats.txt
