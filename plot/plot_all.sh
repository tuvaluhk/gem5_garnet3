...
do
	reward=$(echo "scale=4; $line / 848" | bc)
...
paste injection_rate.txt  Q_minus.txt > Q_plot.txt	
paste injection_rate.txt sarsa_minus.txt > sarsa_plot.txt	
paste injection_rate.txt  esarsa_minus.txt > esarsa_plot.txt	
...
plot \"Q_plot.txt\" smooth unique with linespoint linestyle 3 linecolor 1 pointtype 0 linewidth 2 title \"Sarsa\", \
     \"sarsa_plot.txt\" smooth unique with linespoint linestyle 1 linecolor 2 pointtype 0 linewidth 1.5 title \"QL\", \
     \"esarsa_plot.txt\" smooth unique with linespoint linestyle 2 linecolor 3 pointtype 0 linewidth 1.5 title \"Expected Sarsa\", \
